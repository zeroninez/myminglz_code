// apps/generator/app/fatu-event/page.tsx
"use client";
...
// Fatu Event 전용 설정
const CONFIG = {
  LOCATION_SLUG: "fatu-event",
  BRAND_COLOR: "#FF6B9D",
  SECONDARY_COLOR: "#4ECDC4",
  COMPANY_NAME: "Fatu Event",
};
...
export default function FatuEventPage() {
